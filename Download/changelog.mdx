...
For IT and simulation staff, the launcher gives each station a repeatable startup checklist and a controlled maintenance workflow. Staff can check station readiness, open support, restart or shut down the PC, and exit kiosk mode when station management is needed.
