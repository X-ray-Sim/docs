...
Yes. The Windows installers support silent deployment for MDM tools such as Intune. Review the [MDM deployment instructions](/Tech/v1.9.0/mdm-deployment-instructions) before packaging the installer.
...
3. If the software will be deployed to managed Windows devices, review the [MDM deployment instructions](/Tech/v1.9.0/mdm-deployment-instructions).
...
<CardGroup cols={1}>
  ...
  <Card title="MDM deployment instructions" icon="gears" href="/Tech/v1.9.0/mdm-deployment-instructions">
