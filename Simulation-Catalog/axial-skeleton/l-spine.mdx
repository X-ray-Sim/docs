...
description: "Available anatomy, detector setup, simulated views, bone variations, and known limitations for the lumbar spine simulation module."
---

The L-spine module uses table bucky detector setup with recumbent positioning and right-side decubitus rotation support.

![L-spine simulator preview](/Assets/simulation-catalog/current/l-spine-preview.jpg)

![L-spine example exposure](/Assets/simulation-catalog/current/l-spine-exposure.jpg)
