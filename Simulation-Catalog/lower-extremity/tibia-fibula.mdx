...
<Tabs sync={false}>
  <Tab title="Simulator setup" icon="monitor">
    <Frame caption="Simulator setup and positioning environment">
      <img src="/Assets/simulation-catalog/current/tibia-fibula-preview.jpg" alt="Simulator setup preview for Tibia and Fibula positioning" />
    </Frame>
  </Tab>

  <Tab title="Bone model" icon="bone">
    <Frame caption="Bone model examples from the simulation">
      <img src="/Assets/simulation-catalog/current/tibia-fibula-bones.jpg" alt="Tibia and Fibula bone model examples" />
    </Frame>
  </Tab>
  ...
  <Tab title="Example exposure" icon="image">
    <Frame caption="Example exposure only: shows included anatomy, not a positioning standard or diagnostic-quality image. Results vary with tube, detector, collimation, patient movement, and alignment.">
      <img src="/Assets/simulation-catalog/current/tibia-fibula-anatomy-preview.png" alt="Example exposure from the Tibia and Fibula simulation" />
    </Frame>
  </Tab>
</Tabs>
