...
description: "A Mintlify version of the v1.9.0 X-ray Simulator catalog, organized by anatomy region, imaging setup, supported views, and known limitations."
---
...
This web version is based on the v1.9.0 simulation catalog. Each module page follows the same structure:
