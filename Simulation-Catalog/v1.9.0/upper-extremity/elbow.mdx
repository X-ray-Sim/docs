...
sidebarTitle: "Elbow"
description: "Quick reference for supported elbow views, free-plating setup, movement, bone variations, and current limitations."
---
...
<Tabs sync={false}>
  <Tab title="Simulator setup" icon="monitor">
    <Frame caption="Simulator setup and positioning environment">
      <img src="/Assets/simulation-catalog/v1.9.0/elbow-preview.jpg" alt="Simulator setup preview" />
    </Frame>
  </Tab>

  <Tab title="Bone model" icon="bone">
    <Frame caption="Bone model examples from the simulation">
      <img src="/Assets/simulation-catalog/v1.9.0/elbow-bones.jpg" alt="Elbow bone model examples" />
    </Frame>
  </Tab>
  ...
  <Tab title="Example exposure" icon="image">
    <Frame caption="Example exposure only: shows included anatomy, not a positioning standard or diagnostic-quality image. Results vary with tube, detector, collimation, patient movement, and alignment.">
      <img src="/Assets/simulation-catalog/v1.9.0/elbow-exposure.jpg" alt="Example exposure from the simulator" />
    </Frame>
  </Tab>
</Tabs>
