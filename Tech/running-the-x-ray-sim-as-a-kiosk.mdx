...
sidebarTitle: "Running the VR X-ray Simulator as a Kiosk"
---
...
<Frame caption="VitaSim Launcher station screen during setup checks">
  <img src="/Assets/launcher/vitasim-launcher-preview.png" alt="VitaSim Launcher station screen showing setup checks for Meta Link, headset connection, and Enable Link in headset" />
</Frame>
